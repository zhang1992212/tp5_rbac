...
namespace geek1992\tp5_rbac\command\seed;
...
class Create extends Seed
{
    ...
    {
        $this->setName('rbac:seed:create')
             ->setDescription('Create a new rbac database seeder')
    ...
    {
        return __DIR__.DS.'..'.DS.'..'.DS.'database'.DS.'seeds';
    }
}
